- [Home](https://reference-server.pipecat.ai/en/latest/index.html)
- [Module code](https://reference-server.pipecat.ai/en/latest/_modules/index.html)
- [pipecat](https://reference-server.pipecat.ai/en/latest/_modules/pipecat.html)
- pipecat.transports.websocket.server

* * *

# Source code for pipecat.transports.websocket.server
...
Versions**[latest](https://reference-server.pipecat.ai/en/latest/_modules/pipecat/transports/websocket/server.html)**[stable](https://reference-server.pipecat.ai/en/stable/_modules/pipecat/transports/websocket/server.html)On Read the Docs[Project Home](https://app.readthedocs.org/projects/pipecat-docs/?utm_source=pipecat-docs&utm_content=flyout)[Builds](https://app.readthedocs.org/projects/pipecat-docs/builds/?utm_source=pipecat-docs&utm_content=flyout)Search

* * *

[Addons documentation](https://docs.readthedocs.io/page/addons.html?utm_source=pipecat-docs&utm_content=flyout) ― Hosted by
[Read the Docs](https://about.readthedocs.com/?utm_source=pipecat-docs&utm_content=flyout)